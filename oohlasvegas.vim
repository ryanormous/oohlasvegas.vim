...
if (has('termguicolors') && &t_Co >= 256)
    ...
    let s:yellow   = "#D0BC6C" " HUE:  48.0 LIGHTNESS: 76.35
    let s:cyan     = "#8CD8D8" " HUE: 180.0 LIGHTNESS: 81.64
    let s:violet   = "#DEA8F0" " HUE: 285.0 LIGHTNESS: 75.96
    let s:pink     = "#FE6EAA" " HUE: 335.0 LIGHTNESS: 65.85
    ...
    let s:text     = "#C4D2DC" " HUE: 205.0 LIGHTNESS: 83.44
    ...
    let s:menu     = "#3A1230" " HUE: 315.0 LIGHTNESS: 12.89
    let s:menubar  = "#322A2E" " HUE: 330.0 LIGHTNESS: 18.06
    let s:menusel  = "#522A3E" " HUE: 330.0 LIGHTNESS: 22.99

    let s:normalbg = "#1A1212" " HUE:     0 LIGHTNESS:  6.29
    let s:normalfg = "#D8CECE" " HUE:     0 LIGHTNESS: 83.55
