...
if (has('termguicolors') && &t_Co >= 256)
    ...
    let s:yellow   = "#D0B870" " HUE:  45.0 LIGHTNESS: 75.36
    let s:cyan     = "#96DADA" " HUE: 180.0 LIGHTNESS: 82.75
    let s:purple   = "#DEA2F2" " HUE: 285.0 LIGHTNESS: 74.69
    let s:pink     = "#FE80D4" " HUE: 320.0 LIGHTNESS: 70.36
    let s:red      = "#EC5C68" " HUE: 355.0 LIGHTNESS: 58.50

    let s:grey1    = "#4C4C4C" " HUE:     0 LIGHTNESS: 32.32
    ...
    let s:menu     = "#04344C" " HUE: 200.0 LIGHTNESS: 20.06
    let s:menubar  = "#282C30" " HUE: 210.0 LIGHTNESS: 17.76
    let s:menusel  = "#304A64" " HUE: 210.0 LIGHTNESS: 30.51

    let s:normalbg = "#181212" " HUE:     0 LIGHTNESS:  6.06
    let s:normalfg = "#D8D4D2" " HUE:  20.0 LIGHTNESS: 85.17

    let s:searchbg = "#36343C" " HUE: 255.0 LIGHTNESS: 22.18
    let s:searchfg = "#D0FE46" " HUE:  75.0 LIGHTNESS: 93.77
    ...
    let s:visualbg = "#1A2E6A" " HUE: 225.0 LIGHTNESS: 20.88
    let s:visualfg = "#ACACC4" " HUE: 240.0 LIGHTNESS: 71.05
