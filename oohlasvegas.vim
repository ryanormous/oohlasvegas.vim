...
" GUI HIGHLIGHT
function! s:hl(group, guifg, guibg, guisp, gui, cterm)
    let l:arg = ""
...
" COLOR
let s:coral    = "#f8bebe" " HUE: 0.0  LIGHTNESS: 82.11
let s:gold     = "#E0C0A0" " HUE:  30 LIGHTNESS: 79.66
let s:cyan     = "#98E4E4" " HUE: 180 LIGHTNESS: 85.89
let s:magenta  = "#ECC0EC" " HUE: 300 LIGHTNESS: 82.69
let s:red      = "#FC5462" " HUE: 355 LIGHTNESS: 59.81

let s:grey18   = "#2C2C2C" " HUE:   0 LIGHTNESS: 18.00
...
let s:grey81   = "#CACACA" " HUE:   0 LIGHTNESS: 81.33
...
let s:curline  = "#1E1618" " HUE: 345 LIGHTNESS:  8.27
let s:folded   = "#90867C" " HUE:  30 LIGHTNESS: 56.52
let s:linenum  = "#9a8c8c" " HUE: 0.0  LIGHTNESS: 59.45
let s:nontext  = "#780024" " HUE: 342 LIGHTNESS: 24.07
let s:text     = "#d0d0e8" " HUE: 240.0  LIGHTNESS: 84.15
"let s:text     = "#CAD4E8" " HUE: 220 LIGHTNESS: 84.73
let s:warn     = "#D0B870" " HUE:  45 LIGHTNESS: 75.36
...
let s:menu     = "#003854" " HUE: 200 LIGHTNESS: 21.83
let s:menubar  = "#2C2E30" " HUE: 210 LIGHTNESS: 18.81
let s:menusel  = "#344C64" " HUE: 210 LIGHTNESS: 31.39
let s:menuthum = "#5A5858" " HUE:   0 LIGHTNESS: 37.59

let s:normalbg = "#161010" " HUE:   0 LIGHTNESS:  5.23
let s:normalfg = "#d8d4d2" " HUE: 20.0  LIGHTNESS: 85.17

let s:searchbg = "#3C3848" " HUE: 255 LIGHTNESS: 24.50
let s:searchfg = "#CEFC44" " HUE:  75 LIGHTNESS: 93.08

let s:st_bg    = "#2E3436" " HUE: 195 LIGHTNESS: 21.22
let s:st_fg    = "#BEBEA6" " HUE:  60 LIGHTNESS: 76.39
let s:st_mod   = "#788A42" " HUE:  75 LIGHTNESS: 54.62
let s:stnc_bg  = "#202C30" " HUE: 195 LIGHTNESS: 17.09
let s:stnc_fg  = "#8CA2B8" " HUE: 210 LIGHTNESS: 65.65
...
let s:visualfg = "#B2B2C8" " HUE: 240 LIGHTNESS: 73.20

let s:dir      = "#56AAFE" " HUE: 210 LIGHTNESS: 67.93
let s:exe      = "#6CC06C" " HUE: 120 LIGHTNESS: 70.85
...
hi! link Repeat               Statement
" PREPROC
call s:hl("PreProc", s:magenta, "NONE", "NONE", "NONE", "NONE")
hi! link Define               PreProc
hi! link Include              PreProc
...
hi! link CursorLineSign       Visual
" DEBUG
call s:hl("Debug", s:exe, "NONE", "NONE", "NONE", "NONE")
...
hi! link LineNrBelow          LineNr
" MENU
call s:hl("Pmenu", s:grey81, s:menu, "NONE", "NONE", "NONE")
call s:hl("PmenuSbar", s:menubar, "NONE", "NONE", "NONE", "reverse")
call s:hl("PmenuSel", s:white, s:menusel, "NONE", "NONE", "NONE")
call s:hl("PmenuThumb", s:menuthum, "NONE", "NONE", "NONE", "reverse")
hi! link MessageWindow        Pmenu
hi! link PmenuExtra           Pmenu
hi! link PmenuExtraSel        PmenuSel
hi! link PmenuKind            Pmenu
...
call s:hl("ModeMsg", s:magenta, "NONE", "NONE", "NONE", "NONE")
call s:hl("Todo", s:exe, "NONE", "NONE", "NONE", "bold")
call s:hl("WarningMsg", s:warn, "NONE", "NONE", "NONE", "NONE")
hi! link Exception            ErrorMsg
hi! link MoreMsg              ModeMsg
hi! link PopupNotification    Todo
hi! link Question             ModeMsg
" NETRW
call s:hl("Directory", s:dir, "NONE", "NONE", "NONE", "NONE")
call s:hl("netrwExe", s:exe, "NONE", "NONE", "NONE", "NONE")
...
call s:hl("SpellCap", "NONE", "NONE", s:warn, "underline", "underline")
hi! link SpellLocal           SpellCap
hi! link SpellRare            SpellCap
" STATUSLINE
call s:hl("StatusLine", s:st_fg, s:st_bg, "NONE", "NONE", "NONE")
call s:hl("StatusModified", s:grey18, s:st_mod, "NONE", "NONE", "bold")
call s:hl("StatusReadonly", s:grey18, s:grey44, "NONE", "NONE", "bold")
" STATUSLINE ‘NC’ NOT CURRENT
call s:hl("StatusLineNC", s:stnc_fg, s:stnc_bg, "NONE", "NONE", "NONE")
hi! link StatusLineTerm       StatusLine
hi! link StatusLineTermNC     StatusLineNC
" STATUSLINE MODE
call s:hl("ModeCmd", s:grey18, s:mode_cmd, "NONE", "NONE", "bold")
call s:hl("ModeIns", s:grey18, s:mode_ins, "NONE", "NONE", "bold")
call s:hl("ModeRep", s:grey18, s:grey61, "NONE", "NONE", "bold")
call s:hl("ModeVis", s:grey18, s:mode_vis, "NONE", "NONE", "bold")
" TABLINE
call s:hl("TablineSel", s:menu, "NONE", "NONE", "NONE", "NONE")
...
function! SetStatusline() abort
    ...
    let l:winbuffer = winbufnr(windowid)

    " STATUS LINE
    let l:statline = ' %f%='
  
    " ACTIVE WINDOW
    if windowid == win_getid()
        let l:statline .= GetMode()
    endif

    " MODIFIED
    if getbufvar(winbuffer, '&modified')  
        let l:statline .= '%#StatusModified# modified %*'
    endif

    " READONLY
    if getbufvar(winbuffer, '&readonly')
